...
Dependency-pair techniques form another line of work used in the completeness
proof.  Arts and Giesl gave the classical treatment for termination and
innermost termination \cite{arts_giesl_2000_dependency_pairs}, and the modular
processor framework was subsequently refined and mechanised by Giesl,
Thiemann, Schneider-Kamp, and Falke \cite{giesl2006mechanizing}.  Kassing and
Giesl first adapted dependency-pair techniques to probabilistic innermost
termination using dependency tuples
\cite{kassing_giesl_2023_probabilistic_dp}.  Kassing, Dollase, and Giesl then
obtained a complete framework for innermost AST using annotated dependency
pairs \cite{kassing_dollase_giesl_2024_complete_adp}.  Kassing and Giesl
subsequently unified and extended the ADP framework for innermost and full
probabilistic rewriting \cite{kassing_giesl_2026_adp}; the completeness proof
in this thesis uses its innermost chain criterion and processors.
...
concerns AST; no corresponding claim for PAST or SAST has been made (yet).
...
and limitations.  Finally, \cref{chap:conclusion} summarises the results (and maybe
